        ...
        <div class="col-md-4 d-flex">
            <div class="card shadow-gradient rounded-4 p-4">
                <div class="card-title text-center">
                    ...
                    <h2 class="fw-bold mt-3" style="color: purple;">Create Treatment</h2>
                </div>
                <form action="store.php" method="POST" class="mt-1">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" id="description" name="description" class="form-control py-3" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input type="number" id="doctor_fee" name="doctor_fee" class="form-control" step="0.01" min="0" required>
                        </div>
                    </div>
                    <div class="d-grid">
        ...
        <div class="col-md-8 d-flex">
            <div class="card shadow-gradient rounded-4 p-4 h-75">
                <div class="card-title text-center">
                    ...
                    <h2 class="fw-bold mt-3" style="color: purple;">Pets Reference</h2>
                </div>
