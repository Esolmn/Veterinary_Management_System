        ...
        <div class="col-lg-4 col-md-6">
            ...
            <div class="card shadow rounded-4 p-4 mt-4">
                <div class="card shadow-gradient rounded-4 p-4">
                    ...
                    <p class="text-center">As a <strong class="fw-bold" style="color: orchid;">Super Admin,</strong> you have full control over the entire system. This includes managing users, pets, appointments, treatments, and generating reports. You also have exclusive authority to create and manage Admin accounts.</p>
                    <?php else : ?>
                    <p class="text-center">As an <strong class="fw-bold" style="color: orchid;">Admin,</strong> you can manage pet owners, pets, appointments, treatments, and treatment products. However, only the Super Admin can create or manage Admin accounts.</p>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="card shadow rounded-4 p-4">
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 d-flex justify-content-center mb-3">
                    <div class="card shadow-gradient rounded-4 p-3" style="width: 250px; height: 180px;">
