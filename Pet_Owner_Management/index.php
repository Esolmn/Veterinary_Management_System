...
<div class="container-xxl p-4 shadow-gradient rounded-4 mt-5" style="background-color: white;"> 
    <h1 class="text-center fw-bolder" style="color: orange;">Pet Owners</h1>
    <div class="mt-4 mb-4 d-flex justify-content-between">
    <a class="btn custom-purple-btn" href="create.php">Create Account</a>
        <!-- <div class="ml-auto">
            <a href="../reports/users_report.php" target="_blank" class="btn btn-success">Users PDF</a>
            <a href="../reports/users_report.php?status=active" target="_blank" class="btn btn-success">Active Users PDF</a>
            <a href="../reports/users_report.php?status=Inactive" target="_blank" class="btn btn-success">Inactive Users PDF</a>
        </div> -->
    </div>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                    <a class="btn btn-success me-1" href="show.php?id=<?=$user->id ?>" >
